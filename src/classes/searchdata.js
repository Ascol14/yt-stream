class Video{
    constructor(data, headers){
        ...
        this.url = `https://invidious.fdn.fr/watch?v=${this.id}`;
        ...
        this.channel_url = `https://invidious.fdn.fr${data.ownerText.runs[0].navigationEndpoint.commandMetadata.webCommandMetadata.url}`;
